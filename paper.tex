...
resulted in the development of techniques to increase the throughput
...
thoroughly investigated \cite{Kim, Simplistic1, OptimalDorfmanPool}.
...
intrinsic PCR error rates into account. As we have demonstrated above,
...
a recent study \cite{DOPE}, we have developed a novel pooling scheme
that takes advantage of this specific error model. Our new pooling
scheme shows great promise in terms of both accuracy, as well as
