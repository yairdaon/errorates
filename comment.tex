...
otherwise, all are declared negative. Most analyses of the error rates of pooling schemes
...
depend on the number of negative samples in a pool either. For lack of data pointing otherwise, we incorporate this assumption into our model
