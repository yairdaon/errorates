...
\section{Discussion}
This is my suggestion for a Discussion structure:
short recap; implications for group testing in different prevalence settings; limitations; ways to reduce errors (*cough* DOPE); conclusion/take home message
...
\cite{KitComparison,EstimatingRatesKucrika, EstimatingRatesLourenco,
  InterpretingCOVID19Test} (Figure \ref{figy}). Hence, 
