...
experimental data and suggest a novel and parsimonous probabilistic
...
the prevalence of infection decreases. However, low infection prevalence is exactly the condition when Dorfman pooling achieves highest throughput efficiency. We therefore implore the cautious use of pooling and developement of pooling strategies that consider the tests' error rates. 
